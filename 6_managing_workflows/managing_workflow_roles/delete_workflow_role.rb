...
workflow = SDM::Workflow.new(
  name: 'Ruby Delete WorkflowRole Example',
...
role = SDM::Role.new(
    name: 'Ruby Role for Deleting WorkflowRole Example'
)
...
client.workflow_roles.delete(workflow_role_id, deadline: deadline)
puts 'Successfully deleted WorkflowRole.'