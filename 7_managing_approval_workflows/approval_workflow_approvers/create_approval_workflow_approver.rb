...
approval_workflow = SDM::ApprovalWorkflow.new(
  name: 'Ruby Create Approval Workflow Approver Example',
...
approval_workflow_approver_response = client.approval_workflow_approvers.create(approval_workflow_approver, deadline: deadline)
approval_workflow_approver_id = approval_workflow_approver_response.approval_workflow_approver.id

puts 'Successfully created Approval Workflow Approver (account).'
puts "\tID: #{approval_workflow_approver_id}"
